...
class Locators:
    ...
    INUT_TEST_VALUE = (By.XPATH, "//div[contains(@class = 'select__input')]")
    INPUT_TEST_VALUE = (By.XPATH, "//div[contains(@class, 'select__control')]")
    MY_VALUE_FOR_DEMO = (By.XPATH, "//div[contains(@class 'select__menu' and text() = 'TEST_TAGS')]")
